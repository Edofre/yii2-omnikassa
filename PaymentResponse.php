...
class PaymentResponse extends \yii\base\Model
{
	...
	/** @var  string Identity of the merchant/webshop. This code is provided to each webshop after the Rabo OmniKassa contract is signed */
	public $merchantId;
	...
	/** @var  string Time at which the payment is sent to the acquirer or the moment at which the response code is created on the Rabo OmniKassa server */
