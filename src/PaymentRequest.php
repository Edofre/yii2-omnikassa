...
class PaymentRequest extends \yii\base\Model
{
	...
	public $amount;
	/** @var  string The url OmniKassa will automatically push a response to */
	...
	public $currencyCode;
	/** @var  string Language in which the Rabobank OmniKassa payment page should be displayed. */
	...
	public $orderId;
	/** @var  string List of payment methods from which the customer can choose on the Rabobank OmniKassa payment page */
